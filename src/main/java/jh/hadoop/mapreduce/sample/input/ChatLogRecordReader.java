...
public class ChatLogRecordReader extends RecordReader<LongWritable, ChatLogWritable> {
    ...
    @Override
    public ChatLogWritable getCurrentValue() {
        return new ChatLogWritable(value);
    }
